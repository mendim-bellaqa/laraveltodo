            ...
            <div class="flex items-center justify-center min-h-screen bg-gray-900">
                <div class="col-span-12">
                    <div class="overflow-auto lg:overflow-visible ">
                        ...
                        <div class="flex bg-green-100 mt-10 rounded-lg p-4 mb-4 text-sm text-green-700" role="alert">
                        ...
                        <div class="mt-10 overflow-hidden shadow-xl sm:rounded-lg p-5 text-center">
                            <a href="/todo" class="border-2 border-blue-500 rounded-lg font-bold text-blue-500 px-4 py-3 transition duration-300 ease-in-out hover:bg-blue-500 hover:text-white mr-6">
                                Add New To Do
                            </a>
                        </div>
                        <table class="table text-gray-400 border-separate space-y-6 text-sm">
                            ...
                            @foreach(auth()->user()->todos as $todo)
                                <tr class="bg-gray-800">
                                    ...
                                    <td class="p-3 text-clip overflow-hidden">
                                        {{$todo->description}}
                                    </td>

                                    <td class="p-3">
                                        <a href="/todo/{{$todo->id}}" name="edit" id="edit" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700 text-black py-1 px-2 rounded focus:outline-none focus:shadow-outline">Edit</a>
                                    </td>
